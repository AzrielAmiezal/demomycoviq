          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                ?>
                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= strtoupper($patient['patientName']);  ?></span>
                <img class="img-profile rounded-circle" src="img/<?= $patient['patient_profileImg'] ?>">
              </a>
                        ...
                        <div class="table-responsive">
                          <table class="table">
                            <tr>
                              ...
                              <td>
                                <input class="form-control form-control-sm" type="password" name="patientPassword1" id="myInput">
                                <div class="form-group">
                            ...
                            <tr>
                              ...
                              <td>
                                <input class="form-control form-control-sm" type="password" name="patientPassword2" id="myInput2">
                                <div class="form-group">
                                  <div class="custom-control custom-checkbox small">
