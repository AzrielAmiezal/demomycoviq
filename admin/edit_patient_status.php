...
if (isset($_POST['submit'])) {
  ...
  if (editStatusKuarantin($_POST) > 0) {
    echo "<script>
                              ...
                              <tr>
                                ...
                                <td>
                                  <select class="custom-select custom-select-sm" name="status_kuarantin" id="status_kuarantin" required>
                                    ...
                                    <option value="Sedang dalam pemantauan" <?php if ($pt['status_kuarantin'] == 'Sedang dalam pemantauan') {
                                                                              echo 'selected';
                                                                            } ?>>Sedang dalam pemantauan</option>
                                    <option value="Tamat Kuarantin" <?php if ($pt['status_kuarantin'] == 'Tamat Kuarantin') {
                                                                      echo 'selected';
